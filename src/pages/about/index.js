...
function AboutPage() {
  return (
    <div className="relative">
      {/* Group Photo Section */}
      <div className="bg-fixed bg-center bg-cover" style={{ backgroundImage: "url('/GroupPicture.jpeg')", height: '1000px' }}>
        <div className="bg-gray-800 bg-opacity-50 flex items-center h-full">
          <div className="text-white text-center w-full">
            <h1 className="text-3xl font-bold">Team MAHA</h1>
            <p className="px-3">MAHA is an acronym representing the union of its four foundational members--
            Matt, Alem, Hooghir and Antonio. 
            Matt, the maestro, orchestrates project direction and 
            ensuring all parts of the engineering machine are aligned with the team's goals and client needs.
            Alem, the backbone of the operation, focusing on the backend where he manages server-side logic 
            and databases. 
            Hooghir, the creative force behing the team's UI designs. He crafts interfaces that speak to the user
            and invite engagement. 
            Antonio, the guardian of the digital domain, focusing on security. He ensures both client data
            and user privacy. 
            Together, we have formed a cohesive and productive unit to ensure exellence in our craft.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-fixed bg-center bg-cover py-8" style={{ backgroundImage: "url('/')" }}>
